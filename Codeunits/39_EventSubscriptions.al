...
// Chapter 7 - Lab 2-1
{
  ...
  local procedure EctendNavigateOnAfternavigateFindRecords
...
local procedure ExtendNavigateOnAfterNavigateShowRecords 
  ...
  PostedSeminarRegHeader : record "CSD Posted Seminar Reg. Header"; 
  begin 
    case TableID of Database:: "CSD Posted Seminar Reg. Header": begin 
      PostedSeminarRegHeader.SetFilter("No.",DocNoFilter); 
      ...
      begin SeminarLedgerEntry.SetFilter("Document No.", DocNoFilter); 
